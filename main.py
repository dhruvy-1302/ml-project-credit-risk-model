...
st.title("Dhruv & Sons : Credit Risk Modeling")
...
with row1[1]:
    income = st.number_input('Income',min_value = 0, max_value = 1200000, step = 1000)
with row1[2]:
    loan_amount = st.number_input('Loan Amount',min_value = 0, max_value = 2560000, step = 1000)
...
with row2[2]:
    avg_dpd_per_delinquency = st.number_input("Average DPD", min_value = 0, step = 1, value = 20)
